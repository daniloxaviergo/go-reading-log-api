...
Add GetMaxByWeekday() repository method in dashboard_repository.go to query maximum pages read for a specific weekday. Implement calculation: max(pages_read_on_each_occurrence_of_weekday).
